...
const TRLABEL = { mention: '@mention', name: 'nhắc tên', reply: 'reply', dm: 'tin riêng' };
...
function fillSettings() {
  ...
  $('#cfg-private-on').checked = CONFIG.scan.matchPrivate !== false;
...
$('#save-settings').addEventListener('click', async () => {
  ...
  CONFIG.scan.matchPrivate = $('#cfg-private-on').checked;
  CONFIG.ai = CONFIG.ai || {};
